...
import com.yeel.drc.activity.main.agent.addfund.UploadBankRecieptActivity;
import com.yeel.drc.activity.main.agent.cashpickup.history.CashOutReceiverDocActivity;
import com.yeel.drc.activity.main.agent.cashpickup.history.CashPickupReceiverDocActivity;
...
public class RectangleCropActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            }else  if(from.equals("bank_receipt")){
                crop.setImageBitmap(UploadBankRecieptActivity.bitmap);
            }else  if(from.equals("cash_pickup")){
                crop.setImageBitmap(CashPickupReceiverDocActivity.bitmap);
            }else if(from.equals("upload_personal_id")){
                crop.setImageBitmap(UploadPersonalDocumentActivity.bitmap);
            }else if(from.equals("cash_out_receiver_doc")){
                crop.setImageBitmap(CashOutReceiverDocActivity.bitmap);
            }else if(from.equals("upload_beneficiary_id")){
                crop.setImageBitmap(UploadSenderDocumentsActivity.bitmap);
            }
        }catch (Exception e){
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    ...
                    finalBitmap=getResizedBitmap(croppedBitmap,500,800);
