...
public class CashPickupLocationListAdapter extends RecyclerView.Adapter<CashPickupLocationListAdapter.ViewHolder> {
    List<AgentData> list;
    ...
    public CashPickupLocationListAdapter(List<AgentData> list, Context context, ItemClickAdapterListener onClickListener) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.cash_pickup_location_list_item_style, parent, false);
