...
public class BankSelectionListAdapter extends RecyclerView.Adapter<BankSelectionListAdapter.ViewHolder> {
    List<BankListData> list;
    public ItemClickAdapterListener onClickListener;
    Context context;

    public BankSelectionListAdapter(List<BankListData> list, Context context, ItemClickAdapterListener onClickListener) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        holder.tvHeading.setText(list.get(position).getBankName());
