...
public class NumberListAdapter extends RecyclerView.Adapter<NumberListAdapter.ViewHolder> {
    ...
    public NumberListAdapter(List<String> list, Context context, ItemClickAdapterListener onClickListener) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.number_list_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        holder.tvHeading.setText(list.get(position));
