...
public class MonthListAdapter extends RecyclerView.Adapter<MonthListAdapter.ViewHolder> {
    List<MonthModelModel> list;
    public ItemClickAdapterListener onClickListener;
    Context context;

    public MonthListAdapter(List<MonthModelModel> list, Context context, ItemClickAdapterListener onClickListener) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        holder.tvHeading.setText(list.get(position).getMonthName());
